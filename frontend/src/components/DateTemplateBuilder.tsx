...
export function DateTemplateBuilder({ onGenerate, loading }: DateTemplateBuilderProps) {
  ...
  }, [generatedPrompt, isEditable])

  const handleGenerate = () => {
    const finalPrompt = isEditable ? editablePrompt : generatedPrompt
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4 border border-gray-200">
          ...
          <div className="relative">
            <textarea
              value={isEditable ? editablePrompt : generatedPrompt}
              onChange={(e) => {
                if (isEditable) {
          ...
          <div className="flex justify-between text-sm text-gray-500 mt-2">
            ...
            <span>{(isEditable ? editablePrompt : generatedPrompt).length} 字符</span>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={loading || (!isEditable && !generatedPrompt) || (isEditable && !editablePrompt)}
          ...
          <button
            ...
            disabled={(!isEditable && !generatedPrompt) || (isEditable && !editablePrompt)}
